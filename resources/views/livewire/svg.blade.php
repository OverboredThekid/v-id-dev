        ...
        <div id="svg-card">
            ...
            <svg id="Layer_2" class='' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 155.52 232.23">
                ...
                <g id="Front_ID"><text class="back-4" transform="translate(27.7 227.98)">
                    ...
                    <image xmlns="http://www.w3.org/2000/svg" id="QR_Code_generationsav.com_stafflinks_" width="2255" height="2255" transform="translate(35.55 115.26) scale(.04)" xlink:href="data:image/svg+xml;base64,{{ base64_decode($qrCode) }}" />
