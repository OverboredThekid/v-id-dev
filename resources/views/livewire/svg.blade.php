        ...
        <div id="svg-card">
            ...
            <svg id="Layer_2" class='' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 153.87 240.5">
                ...
                <g id="Back_ID">
                    ...
                    <image style="overflow:visible;" width="377" height="379" id="WORKER-IMG" xlink:href="{{$staff->media->geturl('staff_prints')}}" transform="matrix(0.2535 0 0 0.2535 56.6439 30.8369)"></image>
