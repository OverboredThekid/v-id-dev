            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="img-container">
                        <div class="flex">
                            <div class="w-2/3">
                                <img id="image" src="https://avatars0.githubusercontent.com/u/3456749" class="block max-w-full">
                            </div>
                            <div class="w-1/3">
                                <div class="preview overflow-hidden w-40 h-40 m-2 border border-red-500"></div>
                            </div>
                        </div>
                    </div>
                </div>
