...
class Svg extends Component
{
    ...
    {
        $this->qrCode = base64_encode(QrCode::size(250)->eyeColor(0, 255, 255, 255, 0, 0, 0)->style('square')->format('svg')->merge(asset('/assets/img/gav-small-white.png'), .3)->generate("http://generationsav.com/stafflinks/"));
    }
